...
func (t *ProofArgumentsModel) MarshalCBOR(w io.Writer) error {
	if t == nil {
...
func (t *ProofArgumentsModel) UnmarshalCBOR(r io.Reader) (err error) {
	*t = ProofArgumentsModel{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("ProofArgumentsModel: map struct too large (%d)", extra)
	}
