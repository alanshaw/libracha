...
func (t *TrackArgumentsModel) MarshalCBOR(w io.Writer) error {
	if t == nil {
...
func (t *TrackArgumentsModel) UnmarshalCBOR(r io.Reader) (err error) {
	*t = TrackArgumentsModel{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("TrackArgumentsModel: map struct too large (%d)", extra)
	}
...
func (t *TrackOKModel) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *TrackOKModel) UnmarshalCBOR(r io.Reader) (err error) {
	*t = TrackOKModel{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("TrackOKModel: map struct too large (%d)", extra)
	}
