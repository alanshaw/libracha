...
func (t *EchoArgumentsModel) MarshalCBOR(w io.Writer) error {
	if t == nil {
...
func (t *EchoArgumentsModel) UnmarshalCBOR(r io.Reader) (err error) {
	*t = EchoArgumentsModel{}
	...
	if extra > cbg.MaxLength {
		return fmt.Errorf("EchoArgumentsModel: map struct too large (%d)", extra)
	}
